...
class Featuredproduct extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
	 ...
	 * @param array $data
	 */
	public function __construct(MagentoCatalogBlockProductContext $context, MagentoCatalogModelResourceModelProductCollectionFactory $productCollectionFactory, MagentoCatalogModelProductVisibility $catalogProductVisibility, MagentoFrameworkAppHttpContext $httpContext, array $data = [])
	{
	 ...
	 */
	public function getProductPriceHtml(MagentoCatalogModelProduct $product, $priceType = null, $renderZone = MagentoFrameworkPricingRender::ZONE_ITEM_LIST, array $arguments = [])
	{
		...
		if ($priceRender)
		{
			$price = $priceRender->render(MagentoCatalogPricingPriceFinalPrice::PRICE_CODE, $product, $arguments);
		}
